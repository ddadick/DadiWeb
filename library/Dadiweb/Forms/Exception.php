...
class Dadiweb_Forms_Exception
{
    /**
     * Singleton instance
     * 
     * @var Dadiweb_Forms_Exception
     */    
...
/***************************************************************/
    /**
     * Returns an instance of Dadiweb_Forms_Exception
     * Singleton pattern implementation
     *
     * @return Dadiweb_Forms_Exception Provides a fluent interface
     */
...
/***************************************************************/
     ...
     * @return Dadiweb_Throw_Exception
     */
    public function getMessage($message){
        ...
        foreach ($trace_log as $trace){
            if(
                false===array_search('Dadiweb_Forms_Exception',$trace['args']) &&
                $trace['class']!='Dadiweb_Forms_Exception' &&
