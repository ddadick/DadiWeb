...
class Dadiweb_Db_Exception
{
/**
     * Singleton instance
     * 
     * @var Dadiweb_Db_Exception
     */
    ...
    /**
     * Returns an instance of Dadiweb_Db_Exception
     * Singleton pattern implementation
     *
     * @return Dadiweb_Db_Exception Provides a fluent interface
     */
    ...
    public function getMessage($message){
		...
		foreach ($trace_log as $trace){
			if(false===array_search('Dadiweb_Db_Exception',$trace['args']) && $trace['class']!='Dadiweb_Db_Exception' && $trace['function']!='__call'){
