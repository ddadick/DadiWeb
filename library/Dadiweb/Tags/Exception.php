...
class Dadiweb_Tags_Exception
{
    /**
     * Singleton instance
     * 
     * @var Dadiweb_Tags_Exception
     */    
...
/***************************************************************/
    /**
     * Returns an instance of Dadiweb_Tags_Exception
     * Singleton pattern implementation
     *
     * @return Dadiweb_Tags_Exception Provides a fluent interface
     */
...
/***************************************************************/
    ...
    public function getMessage($message){
        ...
        foreach ($trace_log as $trace){
            if(
                false===array_search('Dadiweb_Tags_Exception',$trace['args']) &&
                $trace['class']!='Dadiweb_Tags_Exception' &&
