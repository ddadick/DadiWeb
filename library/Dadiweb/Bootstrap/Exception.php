...
class Dadiweb_Bootstrap_Exception
{
	/**
     * Singleton instance
     * 
...
/***************************************************************/
    ...
    public function getMessage($message){
		...
		foreach ($trace_log as $trace){
			if(false===array_search('Dadiweb_Bootstrap_Exception',$trace['args']) && $trace['class']!='Dadiweb_Bootstrap_Exception' && $trace['function']!='__call'){
		...
		require_once 'Dadiweb/Throw/Exception.php';
