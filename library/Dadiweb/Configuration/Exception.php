...
class Dadiweb_Configuration_Exception
{
/**
     * Singleton instance
     * 
     * @var Dadiweb_Configuration_Exception
     */
    ...
    /**
     * Returns an instance of Dadiweb_Configuration_Exception
     * Singleton pattern implementation
     *
     * @return Dadiweb_Configuration_Exception Provides a fluent interface
     */
    ...
    public function getMessage($message){
		...
		foreach ($trace_log as $trace){
			if(false===array_search('Dadiweb_Configuration_Exception',$trace['args']) && $trace['class']!='Dadiweb_Http_Exception' && $trace['function']!='__call'){
