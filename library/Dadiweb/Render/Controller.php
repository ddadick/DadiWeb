<?php
class Dadiweb_Render_Controller
{
    /**
     * Singleton instance.
     * 
     * @var null|Dadiweb_Render_Controller
     */
...
/***************************************************************/
     ...
     * @return void
     */
    protected function __construct(array $_options){
        self::build($_options);
    }
...
/***************************************************************/
     ...
     * 
     * @param array $_options
     * @return Dadiweb_Render_Controller
     */
...
/***************************************************************/
    /**
     * Reset instance of Dadiweb_Configuration_Kernel.
     * Singleton pattern implementation.
     *
...
/***************************************************************/
     ...
     * @return void
     */
    protected function build(array $_options=array())
    {
        self::setSettings(Dadiweb_Aides_Array::getInstance()
                ->arr2obj(Dadiweb_Configuration_Settings::getInstance()->getGeneric()));
        self::setPattern(Dadiweb_Configuration_Pattern::getInstance($_options));
        self::setLocale(Dadiweb_Configuration_Locale::getInstance()->getLocale());
        $switch_layout=Dadiweb_Configuration_Kernel::getInstance()->getLayout()->getSwitchLayout();
        $save_view=Dadiweb_Configuration_Kernel::getInstance()->getLayout()->getViewName();
        $save_layout=Dadiweb_Configuration_Kernel::getInstance()->getLayout()->getLayoutName();
        self::setLayout(Dadiweb_Configuration_Layout::getInstance());
        $this->getLayout()->useLayout(false);
        $this->getLayout()->setViewName(NULL);
        ...
        self::getApps()->setGeneric(self::getPattern(),true);
        ...
        Dadiweb_Configuration_Kernel::getInstance()->getLayout()->setLayoutName($save_layout);
        Dadiweb_Configuration_Kernel::getInstance()->getLayout()->setViewName($save_view);
        Dadiweb_Configuration_Kernel::getInstance()->getLayout()->useLayout($switch_layout);
        Dadiweb_Configuration_Kernel::getInstance()->getApps()
            ->setGeneric(Dadiweb_Configuration_Kernel::getInstance()->getPattern());
    }
