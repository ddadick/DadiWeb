...
class Dadiweb_Render_Exception
{
/**
     * Singleton instance
     * 
     * @var Dadiweb_Render_Exception
     */
    ...
    /**
     * Returns an instance of Dadiweb_Render_Exception
     * Singleton pattern implementation
     *
     * @return Dadiweb_Render_Exception Provides a fluent interface
     */
    ...
    public function getMessage($message){
		...
		foreach ($trace_log as $trace){
			if(false===array_search('Dadiweb_Render_Exception',$trace['args']) && $trace['class']!='Dadiweb_Render_Exception' && $trace['function']!='__call'){
