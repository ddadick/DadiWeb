...
class Dadiweb_Aides_Exception
{
/**
     * Singleton instance
     * 
     * @var Dadiweb_Aides_Exception
     */
    ...
    /**
     * Returns an instance of Dadiweb_Aides_Exception
     * Singleton pattern implementation
     *
     * @return Dadiweb_Aides_Exception Provides a fluent interface
     */
    ...
    public function getMessage($message){
		...
		foreach ($trace_log as $trace){
			if(false===array_search('Dadiweb_Aides_Exception',$trace['args']) && $trace['class']!='Dadiweb_Http_Exception' && $trace['function']!='__call'){
