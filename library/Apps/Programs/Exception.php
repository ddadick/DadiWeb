...
class Apps_Programs_Exception
{
/**
     * Singleton instance
     * 
     * @var Apps_Programs_Exception
     */
    ...
    /**
     * Returns an instance of Apps_Programs_Exception
     * Singleton pattern implementation
     *
     * @return Apps_Programs_Exception Provides a fluent interface
     */
    ...
    public function getMessage($message){
		...
		foreach ($trace_log as $trace){
			if(false===array_search('Apps_Programs_Exception',$trace['args']) && $trace['class']!='Apps_Programs_Exception' && $trace['function']!='__call'){
