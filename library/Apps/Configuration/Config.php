    ...
    protected function setGeneric()
    {
        $file=(
            (
                ...
                strlen(
                    $config_file_name=trim(
                        strtolower(
                            Dadiweb_Configuration_Kernel::getInstance()->getSettings()->generic->App->config_file_name
                        )
                    )
                )
            )
            ...
            .(
                (
                    ...
                    strlen(
                        $config_file_exe=trim(
                            strtolower(
                                Dadiweb_Configuration_Kernel::getInstance()->getSettings()->generic->App->config_file_exe
                            )
                        )
                    )
                )
        ...
        if(NULL===Dadiweb_Configuration_Routes::getInstance()->getABC()){
            if(
                Dadiweb_Configuration_Settings::getInstance()->getAppsPath()!=NULL &&
                is_array(Dadiweb_Configuration_Settings::getInstance()->getAppsPath())
            ){
            ...
            if(
                Dadiweb_Configuration_Settings::getInstance()->getABCAppsPath()!=NULL &&
                is_array(Dadiweb_Configuration_Settings::getInstance()->getABCAppsPath())
            ){
